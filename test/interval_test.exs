defmodule Posterize.Extensions.Interval.Encode.Test do
  ...
  test "1 second" do
    assert << 16 :: int32, 1000000 :: int64, 0 :: int32, 0 :: int32 >> == encode(%{ seconds: 1 })
  end
  ...
  test "1 minute" do
    assert << 16 :: int32, 60000000 :: int64, 0 :: int32, 0 :: int32 >> == encode(%{ minutes: 1 })
  end
  ...
  test "1 hour" do
    assert << 16 :: int32, 3600000000 :: int64, 0 :: int32, 0 :: int32 >> == encode(%{ hours: 1 })
  end
  ...
  test "3 years, 7 months, 5 weeks, 2 days, 4 hours, 23 minutes, 17 seconds" do
    ...
    assert << 16 :: int32, 15797000000 :: int64, 37 :: int32, 43 :: int32 >> == encode(interval)
  end
end
